  ...
  return (
      <header className="fixed top-0 left-0 justify-between h-20 shadow flex items-center  w-full z-50  bg-white ">
          ...
          <div>
           ...
           <Link to='/' className='hover:text-cyan-800 font-serif font-semibold'>Home</Link>
           <Link to='/Courses' className='hover:text-cyan-800 font-serif font-semibold'>Courses</Link>
           <Link to='/About' className='hover:text-cyan-800 font-serif font-semibold'>About</Link>
           <Link to='/Scholarships' className='hover:text-cyan-800 font-serif font-semibold'>Scholarships</Link>
           <Link to='/AgentRegistration' className='hover:text-cyan-800 font-serif font-semibold'>Join Our Team</Link>
            </div>
