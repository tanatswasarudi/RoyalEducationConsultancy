        ...
        <div className="max-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2">
            ...
            <ul className="text-gray-500">
              <li className="pb-4"><span className="flex items-center  hover:text-yellow-500 "><Link to={"Scholarships"} className="flex items-center" ><BsChevronBarRight/>Scholarships</Link> </span></li>
              <li className="pb-4"><span className="flex items-center  hover:text-yellow-500"><Link to={"Courses"} className="flex items-center"><BsChevronBarRight/>Courses</Link></span> </li>
              <li className="pb-4"><span className="flex items-center  hover:text-yellow-500"><Link to={"login"} className="flex items-center"><BsChevronBarRight/>Login</Link></span></li>
              <li className="pb-4"><span className="flex items-center  hover:text-yellow-500"><Link to={"register"} className="flex items-center"><BsChevronBarRight/>Register</Link></span></li>
            </ul>
            </div>
            <div className="mb-5">
