...
const Home = () => {
  ...
  return (
    <div className="">
      <div className="w-full  md:h-[400px] h-[300px] m-auto group relative">
  <div style={{ backgroundImage: `url(${slides[currentIndex]})` }} alt="" className="w-full h-auto rounded-2xl duration-500">
  </div>
